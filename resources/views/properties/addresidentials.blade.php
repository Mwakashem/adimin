...
<head>
    ...
    <title>Pls-add Land Plots</title>
    <!-- Fevicon -->
    <!-- Start css -->
    <!-- Switchery css -->
                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            <div class="card-header">
                                <h5 class="card-title">Add Residential</h5>
                            </div>
                            <div class="card-body">
                                <form action="/residentials" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select id="inputState"value="{{ old('type') }}" name="type" class="form-control">
                                                <option selected>Family Home</option>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select id="inputState" name="rooms" class="form-control">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="inputState">Bed Rooms</label>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select id="inputState" name="baths" class="form-control">
                                                <option selected>1</option>
                                                <option>2</option>
                                                <option>3</option>
                                                <option>4</option>
                                    ...
                                    <input type="text" value="residentials" name="ptype" hidden>
