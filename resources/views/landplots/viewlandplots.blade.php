                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">#{{$landplots->id}}</th>
                                                <td><img src="/storage/{{ $landplots-> pimg}}" class="img-fluid immg" width="350" alt="product"></td>
                                                <td class="text-success">{{$landplots->title}}</td>
                                                <!-- <td>$1,70,000</td>
                                                <td>Electronics</td> -->
                                                <td><span class="badge badge-secondary-inverse mr-2">{{$landplots->county}}</span><span class="badge badge-secondary-inverse mr-2">{{$landplots->city}}</span><span class="badge badge-secondary-inverse">{{$landplots->street}}</span></td>
                                                <td>Ksh.{{$landplots->price}}</td>
                                                <td>
                                                    <div class="button-list ">
                                                        <!-- <a href="/{{$landplots->id}}/{{$landplots->ptype}}edit" class="btn btn-success-rgba"><i class="ri-pencil-line"></i></a> -->
                                                        ...
                                                        {{-- <form action="/{{$landplots->id}}" method="post">
                                                            @method('DELETE')
                                                            @csrf
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <form action="/landplots/{{$landplots->id}}" method="post">
                                                                @method('DELETE')
                                                                @csrf
