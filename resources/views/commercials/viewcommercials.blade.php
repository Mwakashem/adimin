                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">#{{$commercials->id}}</th>
                                                <td><img src="/storage/{{ $commercials-> pimg}}" class="img-fluid immg" width="350" alt="product"></td>
                                                <td class="text-success">{{$commercials->title}}</td>
                                                <!-- <td>$1,70,000</td>
                                                <td>Electronics</td> -->
                                                <td><span class="badge badge-secondary-inverse mr-2">{{$commercials->county}}</span><span class="badge badge-secondary-inverse mr-2">{{$commercials->city}}</span><span class="badge badge-secondary-inverse">{{$commercials->street}}</span></td>
                                                <td>Ksh.{{$commercials->price}}</td>
                                                <td>
                                                    <div class="button-list ">
                                                        <!-- <a href="/{{$commercials->id}}/{{$commercials->ptype}}edit" class="btn btn-success-rgba"><i class="ri-pencil-line"></i></a> -->
                                                        ...
                                                        {{-- <form action="/{{$commercials->id}}" method="post">
                                                            @method('DELETE')
                                                            @csrf
                                                        ...
                                                        <div class="btn-group">
                                                            <a href="/commercials/{{$commercials->id}}">
                                                            ...
                                                            <form action="/commercials/{{$commercials->id}}" method="post">
                                                                @method('DELETE')
                                                                @csrf
